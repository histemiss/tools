...
class QuesGrid(wx.grid.PyGridTableBase):
    ...
    def ResetQues(self, qs = []):
        ...
        #删除所有的row
        msg = wx.grid.GridTableMessage(self, wx.grid.GRIDTABLE_NOTIFY_ROWS_DELETED, 0, len(self.all_ques))
        self.GetView().ProcessTableMessage(msg)
        
        #重新构造本地的数组, 不会直接使用参数数组
        self.all_ques = []
        self.all_ques += qs
...
class MainFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.checkbox_grid = wx.CheckBox(self.pane_up, wx.ID_ANY, (u"Grid"))
